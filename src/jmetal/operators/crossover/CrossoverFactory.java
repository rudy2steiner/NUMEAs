...
public class CrossoverFactory {
  ...
  public static Crossover getCrossoverOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("LaplaceCrossover"))
      return new LaplaceCrossover(parameters);
    else if (name.equalsIgnoreCase("PNXCrossover"))
      return new PNXCrossover(parameters);
