...
public class NonUniformMutation extends Mutation{
  ...
  private static final double infmini=10E-06;
  public static double maxMuted=infmini;
  private static int lastGen =0;
  public static Double[] mutedValue;
  /** 
  * Constructor
  ...
  */
  public NonUniformMutation(HashMap<String, Object> parameters) {
  	...
  	if (parameters.get("maxIterations") != null)
        ...
        mutedValue=new Double[maxIterations_];
  } // NonUniformMutation
  ...
  public void doMutation(double probability, Solution solution) throws JMException {                
    ...
    for (int var = 0; var < solution.getDecisionVariables().length; var++) {         
      if (PseudoRandom.randDouble() < probability) {
        ...
        int cg=((Integer)getParameter("currentIteration")).intValue();
//        if(lastGen !=cg) {
//            System.out.println("generation:" + lastGen +":max muted:"+maxMuted);
//             mutedValue[lastGen]=maxMuted;
//             maxMuted=infmini;
//             lastGen =cg;
//        }else{
//          if(tmp>maxMuted){
